...
| --- | --- | --- |
| Unit | Pure functions and façade logic | `tests/categorize-error.test.ts`, `tests/resolve.test.ts`, `tests/with-retries.test.ts`, `tests/facade-internals.test.ts`, `tests/facade-writes.test.ts`, `tests/client-facade.test.ts`, `tests/client-resolver-cache.test.ts`, `tests/thread-context.test.ts`, `tests/webhooks.test.ts`, `tests/scheduled.test.ts`, `tests/rate-limiter.test.ts`, `tests/retries.test.ts`, `tests/telemetry.test.ts` |
| Docs | User-facing docs stay correct and free of forbidden phrases | `tests/docs.test.ts`, `tests/release-evidence.test.ts`, `tests/patch-burndown.test.ts`, `tests/ci-gates.test.ts`, `tests/spec-quality-audit.test.ts`, `tests/goal-registry.test.ts` |
