 ...
 * @generated-id: 9d872ceed956
 */

import * as z from "zod/v3";

export interface Env {
  PUMBLESDK_API_KEY_AUTH?: string | undefined;

  PUMBLESDK_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  PUMBLESDK_API_KEY_AUTH: z.string().optional(),

  PUMBLESDK_DEBUG: z.coerce.boolean().optional(),
});
