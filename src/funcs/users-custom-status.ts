 ...
 * immediately clear.
 */
export function usersCustomStatus(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CustomStatusRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/customStatus")();
