 ...
 * `sendReply`).
 */
export function messagesSendMessage(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SendMessageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sendMessage")();
