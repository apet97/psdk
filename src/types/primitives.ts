...
export function string(): z.ZodType<string, z.ZodTypeDef, unknown> {
  return z.union([
    z.string(),
...
export function boolean(): z.ZodType<boolean, z.ZodTypeDef, unknown> {
  return z.union([
    z.boolean(),
...
export function number(): z.ZodType<number, z.ZodTypeDef, unknown> {
  return z.union([
    z.number(),
...
function zodDefaultToZeroValue<T>(
  value: T,
): z.ZodType<T, z.ZodTypeDef, unknown> {
